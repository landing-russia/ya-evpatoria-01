        ...
        <div class="relative flex justify-between h-16 lg:h-18">
            ...
            <div class="flex-1 flex items-center justify-center md:items-stretch md:justify-start">
                ...
                <div class="hidden md:ml-6 md:flex md:items-center lg:ml-12">
                    <a href="/"
                        class="ml-3 block rounded-full font-semibold text-sm px-3 py-1 lg:text-base lg:px-4 lg:py-2 {{ (request()->is('/')) ? 'text-gray-900 bg-amber-400 dark:bg-amber-600  dark:text-white' : 'text-gray-500 dark:text-gray-500 hover:bg-gray-100 dark:hover:text-gray-300 hover:text-gray-900 dark:hover:bg-gray-800' }} transition duration-150 ease-in-out">
                        Афиша
                    </a>
                    <a href="/excursions"
                        class="ml-3 block rounded-full font-semibold text-sm px-3 py-1 lg:text-base lg:px-4 lg:py-2 {{ (request()->is('excursions')) ? 'text-gray-900 bg-amber-400 dark:bg-amber-600  dark:text-white' : 'text-gray-500 dark:text-gray-500 hover:bg-gray-100 dark:hover:text-gray-300 hover:text-gray-900 dark:hover:bg-gray-800' }} transition duration-150 ease-in-out">
                        Экскурсии
                    </a>
                    <a href="#"
