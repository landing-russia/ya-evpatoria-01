            ...
            <div class="relative flex justify-between h-16 lg:h-18">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 md:pr-0">
                    ...
                    if(localStorage.theme == 'dark') {
                        ...
                        class="hidden sm:block mr-2 p-1 border-2 border-transparent text-amber-500 dark:text-gray-700 rounded-full hover:text-amber-600 dark:hover:text-gray-500 focus:outline-none focus:text-amber-600 focus:bg-gray-100 dark:focus:bg-gray-800 transition duration-150 ease-in-out">
                        <template x-if="!dark">
